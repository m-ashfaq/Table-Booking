...
var newBooking = function newBooking() {
  $(document).on("submit", "form#form-Restaurant", function (e) {
    ...
    console.log("request body: ".concat(JSON.stringify(requestBody, null, 2))); // Event listener to for Delete Fruit Button

    $(document).on("click", "#delete-booking", /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return $.ajax({
                  type: "DELETE",
                  url: "/api/booking/delete-booking/".concat($("#bookingId").val()),
                  contentType: "application/json"
                });
